...
row. Local `zipxDepUpdate` looks up Maven metadata and rewrites constructors after approval. You own the catalog;
Scala Steward is optional leftover automation, not required. Not an M12 item.
