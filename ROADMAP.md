...
5. No stringly-typed construction in the public API: every string that reaches YAML comes from a validated Scala value or a linted, warned raw escape hatch.
